...
@register_model("transformer_knn")
class TransformerKNNModel(FairseqEncoderDecoderModel):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument("--dstore-file", default=None, type=str)
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        return TransformerKNNEncoder(args, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return TransformerKnnDecoder(
            args,
            tgt_dict,
            embed_tokens,
...
class TransformerKNNEncoder(FairseqEncoder):
    """
...
class TransformerKnnDecoder(FairseqIncrementalDecoder):
    """
    ...
    def get_normalized_probs(self, 
        ...
        if self.use_knn_datastore:
            ...
            # split the log-softmax
            # because we need add knn probs to the original network probs
            network_probs = utils.softmax(logits, dim=-1, onnx_trace=self.onnx_trace)
...
@register_model_architecture("transformer_knn", "transformer_knn")
...
@register_model_architecture("transformer_knn", "transformer_base")
...
@register_model_architecture("transformer_knn", "transformer_knn_wmt19_de_en_with_datastore")
def transformer_wmt19_de_en_with_datastore(args):
    transformer_wmt19_de_en(args)


@register_model_architecture("transformer_knn", "transformer_knn_wmt19_de_en")
...
@register_model_architecture("transformer_knn", "transformer_knn_wmt_en_de_big")
def transformer_wmt_en_de_big(args):
    args.attention_dropout = getattr(args, "attention_dropout", 0.1)
    transformer_vaswani_wmt_en_de_big(args)

@register_model_architecture("transformer_knn", "transformer_knn_vaswani_wmt_en_de_big")
