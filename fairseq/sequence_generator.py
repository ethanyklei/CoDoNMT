...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        ######################################################
        prev_tgt_ctx_tokens = None
        if "prev_tgt_ctx_tokens" in net_input:
            prev_tgt_ctx_tokens = net_input["prev_tgt_ctx_tokens"]
        ######################################################
        ...
        if prev_tgt_ctx_tokens is not None:
            prev_tgt_ctx_tokens = prev_tgt_ctx_tokens.index_select(0, new_order)
        ##############################################################
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            if reorder_state is not None:
                ...
                #######################################################
                if prev_tgt_ctx_tokens is not None:
                    prev_tgt_ctx_tokens = prev_tgt_ctx_tokens.index_select(0, reorder_state)
                #######################################################
