...
def main(args):
    ...
    # NOTE: Add
    if args.src_context:
        make_all(f"context.{args.source_lang}", src_dict)
    if args.tgt_context:
        make_all(f"context.{args.target_lang}", tgt_dict)
    #################################
...
def cli_main():
    ...
    parser.add_argument("--src-context", action="store_true")
    parser.add_argument("--tgt-context", action="store_true")
